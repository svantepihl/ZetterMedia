      ...
      <div class="grid px-6 grid-cols-1 md:grid-cols-5 gap-x-12 gap-y-32 mx-auto">
        ...
        <div class="col-span-1 md:col-span-2 md:col-start-1 flex items-center justify-end h-full text-center">
            <div class="container flex flex-col items-start justify-start">
                <div class="mx-auto">
                    <h1 class="text-3xl lg:text-4xl uppercase font-bold border-b-2 border-black">
                        Address
                    </h1>
                ...
                <div class="mx-auto mt-4">
                    ...
                    <p class="text-xl lg:text-2xl font-semibold">
                        <a target="#" href="mailto:info@zettermedia.se?subject=Hej!">info@zettermedia.com</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="border-white col-span-1 md:col-span-2 md:col-start-4 flex justify-center items-center flex-col">
            <div class="container h-full max-w-2xl flex justify-start items-center flex-col">
